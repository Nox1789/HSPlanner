...
import type { Inventory, RangedStatMap, RangedValue } from '../../types'
...
import type { FilterTab } from './statKeys'
import { Panel, SectionHeading, SubSectionLabel } from './statPrimitives'
import { MainSkillSection } from './MainSkillPanel'
import { SkillCard } from './SkillCard'
import { AttributesStrip, StatRow } from './rows'
...
export function StatsPanel({
  ...
  const classId = buildDeps.classId
  const skillRanks = buildDeps.skillRanks
  const enemyConditions = buildDeps.enemyConditions
  const skillProjectiles = buildDeps.skillProjectiles
  const enemyResistances = buildDeps.enemyResistances
  const activeSkillIds = buildDeps.activeSkillIds
